---
title: "Plantilla: Política interna de uso de inteligencia artificial"
description: "Plantilla completa y editable de política corporativa de uso de IA para empresas españolas. Cumple con el artículo 4 del AI Act y con el RGPD. Lista para adaptar al nombre de tu empresa y ámbito."
author: "Ana María González"
author_role: "Directora de CiberAula"
published: "2026-04-17"
updated: "2026-04-17"
canonical_url: "https://github.com/Ciberaula/ia-empresas-espana/blob/main/cumplimiento/plantilla-politica-uso-ia.md"
license: "CC BY-SA 4.0 (texto) + dedicación a dominio público de las cláusulas legales"
...
1. Lee el documento completo antes de editarlo para entender su estructura.
2. Sustituye los campos `[CORCHETES]` por tus datos.
3. Revisa las secciones marcadas `[OPCIONAL]` y decide cuáles aplican.
4. Adapta las listas de sistemas permitidos a la realidad de tu empresa.
5. Haz firmar el documento a la dirección, comunícalo formalmente a la plantilla y recoge firma de cada empleado.
6. Archívalo junto con el inventario de sistemas IA y los registros de formación.
7. Actualiza anualmente o cuando cambien las herramientas IA utilizadas.
...
Firma del responsable de la empresa: _______________________
...
- ✅ [Checklist de cumplimiento AI Act](checklist-cumplimiento-ai-act.md) — verifica tu estado.
- 📋 [Plantilla de registro de sistemas IA](plantilla-registro-sistemas-ia.md) — inventario obligatorio.
- 🎓 [Formación bonificada FUNDAE](https://www.ciberaula.com/cursos-bonificados/)

---

*Plantilla publicada bajo licencia [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.es) para el texto marco. Las cláusulas legales (secciones 1-12) se dedican al dominio público para facilitar su uso por cualquier empresa sin obligación de atribución.*
