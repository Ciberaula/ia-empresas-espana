---
title: "AESIA y AEPD: quién supervisa la IA en España"
description: "Competencias, funciones y ámbito de actuación de AESIA (Agencia Española de Supervisión de la IA), AEPD (protección de datos) y otros organismos sectoriales con responsabilidad sobre sistemas de IA."
author: "Ana María González"
author_role: "Directora de CiberAula"
published: "2026-04-17"
updated: "2026-04-17"
canonical_url: "https://github.com/Ciberaula/ia-empresas-espana/blob/main/cumplimiento/aesia-aepd-competencias.md"
license: "CC BY-SA 4.0"
tags: ["aesia", "aepd", "ai-act", "cumplimiento", "supervision-ia"]
---
...
1. [Mapa de organismos: quién supervisa qué](#mapa)
2. [AESIA — Agencia Española de Supervisión de la IA](#aesia)
3. [AEPD — Agencia Española de Protección de Datos](#aepd)
4. [Coordinación entre AESIA y AEPD](#coordinacion)
5. [Reguladores sectoriales](#sectoriales)
6. [Cómo preparar a tu empresa para una inspección](#inspeccion)
7. [Preguntas frecuentes](#faq)

---

## <a id="mapa"></a>1. Mapa de organismos: quién supervisa qué
...
## <a id="aesia"></a>2. AESIA — Agencia Española de Supervisión de la IA
...
AESIA aún está consolidando su estructura operativa. La información oficial actualizada se publica en [aesia.gob.es](https://www.aesia.gob.es). Las comunicaciones formales se realizan preferentemente a través de la sede electrónica del Ministerio de Transformación Digital y Función Pública.

Para consultas ciudadanas no vinculantes, el buzón es `info@aesia.gob.es`.

---

## <a id="aepd"></a>3. AEPD — Agencia Española de Protección de Datos
...
La mayoría están disponibles en [aepd.es/guias](https://www.aepd.es).
...
## <a id="coordinacion"></a>4. Coordinación entre AESIA y AEPD
...
## <a id="sectoriales"></a>5. Reguladores sectoriales
...
## <a id="inspeccion"></a>6. Cómo preparar a tu empresa para una inspección
...
1. **Inventario actualizado de sistemas IA** usados por la empresa, con su clasificación de riesgo AI Act.
2. **Política interna de uso de IA** firmada por dirección y aceptada por cada empleado que usa IA.
3. **Registros de formación** de cumplimiento del artículo 4 para cada empleado afectado.
4. **EIPD (Evaluación de Impacto en Protección de Datos)** para los sistemas IA que traten datos personales a gran escala o con riesgo elevado.
5. **Documentación técnica** de los sistemas IA (manuales de uso, fichas técnicas del proveedor, información sobre entrenamiento y limitaciones).
6. **Contratos con proveedores de IA** con cláusulas sobre responsabilidad, anonimización, no-entrenamiento sobre datos, soporte regulatorio.
7. **Designación formal del responsable del cumplimiento** IA dentro de la empresa.
8. **Registro de incidentes** relacionados con IA si los hubo, con gestión documentada.
9. **Registro de accesos y actividad** de los sistemas IA (logging, mínimo los últimos 24 meses).
10. **Plan de respuesta a incidentes** específico para sistemas IA.
...
## <a id="faq"></a>7. Preguntas frecuentes
...
- 📗 [El artículo 4 en detalle](alfabetizacion-ia-articulo-4.md) — obligación de alfabetización.
- ✅ [Checklist de cumplimiento AI Act](checklist-cumplimiento-ai-act.md) — puntos accionables.
- 📋 [Plantilla de política de uso de IA](plantilla-politica-uso-ia.md) — modelo firmable.

### Enlaces oficiales

- [AESIA — Agencia Española de Supervisión de la IA](https://www.aesia.gob.es)
- [AEPD — Agencia Española de Protección de Datos](https://www.aepd.es)
- [Real Decreto 729/2023 — creación de AESIA](https://www.boe.es/buscar/doc.php?id=BOE-A-2023-18911)
