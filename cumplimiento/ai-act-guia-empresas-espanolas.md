...
1. [Qué es el AI Act y por qué te afecta aunque no desarrolles IA](#que-es)
2. [Calendario de aplicación: qué está en vigor ya y qué viene](#calendario)
3. [Clasificación por niveles de riesgo: dónde está tu empresa](#niveles-riesgo)
4. [El artículo 4: la obligación que ya es exigible en 2026](#articulo-4)
5. [Obligaciones concretas por tipo de empresa](#obligaciones)
...
## <a id="que-es"></a>1. Qué es el AI Act y por qué te afecta aunque no desarrolles IA
...
## <a id="calendario"></a>2. Calendario de aplicación: qué está en vigor ya y qué viene
...
## <a id="niveles-riesgo"></a>3. Clasificación por niveles de riesgo: dónde está tu empresa
...
## <a id="articulo-4"></a>4. El artículo 4: la obligación que ya es exigible en 2026
...
## <a id="obligaciones"></a>5. Obligaciones concretas por tipo de empresa
...
## <a id="organismos"></a>6. Organismos supervisores en España: AESIA, AEPD y otros
...
## <a id="sanciones"></a>7. Sanciones: hasta dónde pueden llegar
...
## <a id="plan-90-dias"></a>8. Plan de adopción en 90 días
...
- **Texto oficial del Reglamento (UE) 2024/1689** en EUR-Lex: [eur-lex.europa.eu/legal-content/ES/ALL/?uri=CELEX:32024R1689](https://eur-lex.europa.eu/legal-content/ES/ALL/?uri=CELEX:32024R1689)
- **Referencia en BOE** (DOUE-L-2024-81079): [boe.es/buscar/doc.php?id=DOUE-L-2024-81079](https://www.boe.es/buscar/doc.php?id=DOUE-L-2024-81079)
- **AI Act Explorer** (navegación interactiva en español): [artificialintelligenceact.eu/es/ai-act-explorer](https://artificialintelligenceact.eu/es/ai-act-explorer/)

### Autoridades

- **AESIA — Agencia Española de Supervisión de la IA**: [aesia.gob.es](https://www.aesia.gob.es) (cuando disponible)
...
- [El artículo 4 en detalle: alfabetización IA obligatoria](alfabetizacion-ia-articulo-4.md)
- [Competencias de AESIA y AEPD en IA](aesia-aepd-competencias.md)
- [Checklist de cumplimiento AI Act — 30 puntos](checklist-cumplimiento-ai-act.md)
- [Plantilla de política de uso de IA en la empresa](plantilla-politica-uso-ia.md)
- [Plantilla de registro interno de sistemas IA](plantilla-registro-sistemas-ia.md)
